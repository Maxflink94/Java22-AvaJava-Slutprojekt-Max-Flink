...
import log.LogInfo;
import producerConsumerPattern.Buffer;
import producerConsumerPattern.Producer;
...
public class GUI implements Runnable {
	...
	public void createAndShowGUI(Buffer buffer) {
		...
		addButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// Loggar antalet arbetare till Textfil
				gui.log.writeData("Lade till en arbetare. Antal arbetare: " + gui.workerAmount);

				// Loggar antalet arbetare och deras produktionsintervall till programloggen
				appendToProgLog("Lade till en arbetare med arbetsintervallet " + producer.getRandomInt()
		...
		removeButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (!gui.producerThreadQueue.isEmpty()) {
					...
					// Loggar antalet arbetare till Textfil
					gui.log.writeData("Tog bort en arbetare. Antal arbetare: " + gui.workerAmount);

					// Loggar antalet arbetare till programloggen
					appendToProgLog("Tog bort en arbetare. Antal arbetare: " + gui.workerAmount);
	...
	// Metod för att lägga till text till de aktiva programmets log
	public void appendToProgLog(String message) {
